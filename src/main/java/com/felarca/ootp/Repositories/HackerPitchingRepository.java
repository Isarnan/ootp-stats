...
public interface HackerPitchingRepository extends JpaRepository<HackerPitching, Integer>
{	
	...
	List<HackerPitching> findAllByIpGreaterThanEqual(long ip, Sort sort );
	HackerPitching findOneByCid(int cid);
